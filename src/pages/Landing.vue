          ...
          <div class="hero-card card">
            ...
            <div class="grid stats-grid">
              <div class="card-soft" style="text-align: center">
                <strong style="font-size: 2.2rem">128</strong>
                <span>Total Tickets</span>
              </div>
              <div class="card-soft" style="text-align: center">
                <strong style="font-size: 2.2rem; color: #2f8f46">52</strong>
                <span>Open</span>
              </div>
              <div class="card-soft" style="text-align: center">
                <strong style="font-size: 2.2rem; color: #a86a08">34</strong>
                <span>In Progress</span>
              </div>
              <div class="card-soft" style="text-align: center">
                <strong style="font-size: 2.2rem; color: #495057">42</strong>
                <span>Closed</span>
              </div>
            </div>
